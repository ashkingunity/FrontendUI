...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPushSoftPushWidgetDelegate, UWidget_ActivatableBase*, PushedWidget);
/**
 * 
 */
UCLASS()
...
public:
	...
	FOnPushSoftPushWidgetDelegate OnWidgetCreatedBeforePush;
	
	UPROPERTY(BlueprintAssignable)
	FOnPushSoftPushWidgetDelegate AfterPush;
